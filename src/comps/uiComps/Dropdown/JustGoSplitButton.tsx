      ...
      <Menu as="div" className="relative inline-block text-left">
        <div className="flex items-center border border-black rounded-sm pl-2 pr-2 pt-2 pb-2">
          <span
            ...
            onClick={options[0].action && options[0].action}
          >
            {options[0].icon || ""}
            {options[0].title}
          </span>
          ...
          <Menu.Button>
            ...
            >
              <path
                d="M4.66699 6.6665L8.00033 9.99984L11.3337 6.6665H4.66699Z"
                fill="#263238"
              />
            </svg>
          </Menu.Button>
        ...
        >
          <Menu.Items
            className={`absolute md:left-0 sm:right-auto lg:left-auto lg:right-0 mt-1 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50 ${
              isLastItem && "bottom-11"
            }`}
          >
